...
<body>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up">
      <h1>Batu Tourism Object</h1>
      <h2>Let's find your destination trip!</h2>
        ...
        <div class="row no-gutters">
          <div class="content col-xl-7 d-flex align-items-stretch" data-aos="fade-up">
            <div class="content">
              ...
              <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/Thud1PQhGJ4" allowfullscreen height="400" width="600"></iframe>
              </div>
            </div>
          </div>
          <div class="col-xl-5 d-flex align-items-stretch content">
              <div class="section-title" data-aos="fade-in" data-aos-delay="100">
                <h2>Kota Wisata Batu</h2>
                <p>Kota Batu adalah sebuah kota di Provinsi Jawa Timur, Indonesia. Kota ini terletak 90 km sebelah barat daya Surabaya atau 15 km sebelah barat laut Malang. 
                  Batu dikenal sebagai salah satu kota wisata terkemuka di Indonesia karena potensi keindahan alam yang luar biasa. Kekaguman bangsa Belanda terhadap keindahan dan keelokan alam Batu membuat wilayah kota Batu disejajarkan dengan sebuah negara di Eropa yaitu Swiss dan dijuluki sebagai De Kleine Zwitserland atau Swiss Kecil di Pulau Jawa</p>
              </div>
          </div>
        </div>
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in">
        ...
        <div class="text-center">
          ...
          <a class="cta-btn" href="maps.php">See The Maps</a>
        </div>
